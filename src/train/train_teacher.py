...
def train_teacher():
    ...
    # 3. Configure Hardware-Optimized Training Arguments (RTX 4080 / 4090)
    training_args = Seq2SeqTrainingArguments(
        ...
        gradient_accumulation_steps=4,  # Simulates effective batch size of 16
        weight_decay=0.01,
        save_total_limit=2,
        num_train_epochs=3,
    ...
    print("Teacher adaptation complete. Checkpoint saved to ./saved_models/final_teacher_model")
